      ...
      <main>
        ...
        <section className="bg-white py-16 md:py-24 pb-24 md:pb-32 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            {/* Hero Image - Group Photo - Positioned to have bottom covered by waves */}
            ...
            <div className="relative z-20 pt-32 md:pt-40 pb-16 md:pb-24">
              <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                  {/* Blog Card */}
                  <Card className="bg-white rounded-2xl shadow-xl overflow-hidden animate-fade-in-up delay-100 hover:transform hover:scale-105 transition-all duration-300">
                  ...
                  {/* Lifestyle Card */}
                  <Card className="bg-white rounded-2xl shadow-xl overflow-hidden animate-fade-in-up delay-200 hover:transform hover:scale-105 transition-all duration-300">
                    <CardContent className="p-6 md:p-8">
                  ...
                  {/* Research Card */}
                  <Card className="bg-white rounded-2xl shadow-xl overflow-hidden animate-fade-in-up delay-300 hover:transform hover:scale-105 transition-all duration-300">
                    <CardContent className="p-6 md:p-8">
