        ...
        <section className="bg-white py-12 md:py-16 lg:py-20 relative">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className="max-w-5xl mx-auto mb-12 sm:mb-16 lg:mb-20 animate-fade-in-up">
              ...
              <Button className="bg-gray-800 hover:bg-gray-900 text-white px-8 sm:px-10 lg:px-12 py-4 sm:py-5 lg:py-6 rounded-lg border-2 border-black text-base sm:text-lg lg:text-xl font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg flex items-center space-x-2 sm:space-x-3 mx-auto">
